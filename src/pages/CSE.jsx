        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            ...
            <div data-aos="zoom-in">
              <img
                src={`${import.meta.env.BASE_URL}/images/courses/cse.jpg`}
                alt="Department"
                className="
                  w-full
                  h-[250px]
            ...
            <div data-aos="fade-left">
              ...
              <p className="mt-6 text-gray-600 leading-8 text-base md:text-lg text-justify">
                ...
                quality technical education with a focus on innovation,
                programming, software development, artificial intelligence,
                cloud computing, cybersecurity and emerging technologies.
                The department equips students with strong theoretical
                knowledge and practical skills to meet the demands of the
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            >
              ...
              <p className="text-gray-600 leading-8">
                ...
                Engineering education, research and innovation by producing
                competent professionals capable of addressing global
            ...
            >
              ...
              <p className="text-gray-600 leading-8">
                To provide quality education, encourage innovation, promote
                research activities, develop professional ethics and prepare
                students for successful careers in computing and related
                fields.
              </p>
            </div>
          </div>
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          >
            ...
            <ul className="space-y-5 text-gray-600 leading-8">
              <li>
                • Consistent academic excellence and university results.
              </li>

              <li>
                • Student participation in national and international
                technical events.
              </li>

              <li>
                • Innovative student projects and research activities.
              </li>

              <li>
                • Industry-oriented certification and skill development
                programs.
              </li>

              <li>
                • Strong placement and higher education opportunities.
              </li>
            </ul>
          </div>
        </div>
