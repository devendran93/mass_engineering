...
export default function VisionMission() {
  ...
  const missionPoints = [
    ...
    "Strengthen industry interaction",
    "Develop leadership and ethics",
        ...
        <div className="max-w-7xl mx-auto px-5 grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div data-aos="fade-left">
            ...
            <p className="mt-6 text-gray-600 leading-8 text-lg">
              ...
              To become a centre of excellence in engineering education,
              research and innovation by producing globally competent
              professionals with ethical values, leadership qualities
        ...
        <div className="max-w-7xl mx-auto px-5 grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div data-aos="fade-right">
            ...
            <h2 className="mt-6 text-4xl font-bold text-slate-900">
              ...
              Building Engineers For Tomorrow
            ...
            {values.map((value, index) => (
              ...
              >
                ...
                <p className="mt-3 text-gray-600">
                  ...
                  We nurture students with strong values and commitment towards excellence.
