  ...
  return (
    <div className="bg-white overflow-hidden">
      ...
      <section className="py-16 md:py-24 bg-gradient-to-r from-rose-900 via-rose-800 to-rose-700 text-center px-4">
        ...
        Connecting Innovation with Communication Technologies
        </p>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            ...
            <div data-aos="zoom-in">
              <img
                src={`${import.meta.env.BASE_URL}/images/courses/ece.jpg`}
                alt="Department"
                className="
                  w-full
                  h-[250px]
            ...
            <div data-aos="fade-left">
              ...
              <p className="mt-6 text-gray-600 leading-8 text-base md:text-lg text-justify">
                ...
                the design, development and application of electronic devices,
                communication systems and embedded technologies. The department
                provides students with strong theoretical foundations and practical
                skills in electronics, wireless communication, signal processing,
                VLSI design, IoT and modern communication networks. The programme
                prepares students to meet the challenges of rapidly evolving
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            >
              ...
              <p className="text-gray-600 leading-8">
                To be a center of excellence in Electronics and Communication
                Engineering through quality education, innovation, research and
                industry collaboration for societal development.
              </p>
            </div>
            ...
            >
              ...
              <p className="text-gray-600 leading-8">
                To impart quality education in Electronics and Communication
                Engineering, encourage innovation and research, strengthen industry
                interaction and develop technically competent professionals with
                ethical values.
              </p>
            </div>
          </div>
      ...
      <section className="py-16 md:py-20">
        <div className="max-w-6xl mx-auto px-4">
          ...
          >
            ...
            <li>
                • Excellent academic performance and university examination results.
            </li>

            <li>
                • Student participation in national-level technical competitions.
            </li>

            <li>
                • Innovative projects in communication and embedded systems.
            </li>

            <li>
                • Industry-oriented workshops and certification programmes.
            </li>

            <li>
                • Successful placements in electronics, communication and IT sectors.
            </li>
            </ul>
          </div>
        </div>
